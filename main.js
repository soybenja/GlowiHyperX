...
conn.welcome = '-------------------------------------------------\n❗ *GLOWI BOT*\n┣・🧸𝙃𝙊𝙇𝘼𝘼𝘼 @user\n┣・🧸𝙏𝙀 𝘿𝘼𝙈𝙊𝙎 𝙇𝘼 𝘾𝙊𝙍𝘿𝙄𝘼𝙇 𝘽𝙄𝙀𝙉𝙑𝙀𝙉𝙄𝘿𝘼\n┣・🧸𝙉𝙐𝙈𝙀𝙍𝙊 𝘿𝙀 𝙈𝙄 𝘾𝙍𝙀𝘼𝘿𝙊𝙍 ‍𝑩𝑬𝑵𝑱𝑨\nwa.me/51936732723\n┣・🧸𝙉𝙐𝙈𝙀𝙍𝙊 𝘿𝙀 𝙈𝙄 𝙊𝙒𝙉𝙀𝙍 GLOWI BOT\nwa.me/5493815526931\n┣・🧸𝙏𝙀 𝙄𝙉𝙑𝙄𝙏𝙊 𝘼 𝙇𝙀𝙀𝙍 𝙇𝘼 𝘿𝙀𝙎𝘾𝙍𝙄𝙋𝘾𝙄𝙊𝙉 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊:\n@desc\n┣・*GLOWI BOT*\n-------------------------------------------------'
conn.bye = '-------------------------------------------------\n┣・🧸 @user\n┣・🧸GLOWI BOT 𝙏𝙀 𝙃𝘼𝘾𝙀 𝙇𝘼 𝘾𝙊𝙍𝘿𝙄𝘼𝙇 𝘿𝙀𝙎𝙋𝙀𝘿𝙄𝘿𝘼 𝘿𝙀 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊, 𝙃𝘼𝙎𝙏𝘼 𝙋𝙍𝙊𝙉𝙏𝙊🧸❤\n\n┣・ *𝙔𝘼 𝙉𝙊 𝙁𝙊𝙍𝙈𝘼𝙎 𝙋𝘼𝙍𝙏𝙀 𝘿𝙀 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊*\n┣・ *GLOWI BOT*\n-------------------------------------------------'
conn.spromote = '❗ *GLOWI BOT* 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀  @user 𝙀𝙎 𝙐𝙉 𝙉𝙐𝙀𝙑𝙊 𝘼𝘿𝙈𝙄𝙉 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊\n\n*𝙔𝘼 𝙏𝙄𝙀𝙉𝙀𝙎 𝙇𝙊𝙎 𝙋𝙊𝘿𝙀𝙍𝙀𝙎 𝘿𝙀 𝘼𝘿𝙈𝙄𝙉*'
conn.sdemote = '❗ *GLOWI BOT* 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀 @user 𝙔𝘼 𝙉𝙊 𝙀𝙎 𝙐𝙉 𝘼𝘿𝙈𝙄𝙉 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊\n\n*𝙔𝘼 𝙉𝙊 𝙏𝙄𝙀𝙉𝙀𝙎 𝙇𝙊𝙎 𝙋𝙊𝘿𝙀𝙍𝙀𝙎 𝘿𝙀 𝘼𝘿𝙈𝙄𝙉*'
conn.sDesc = '❗ *GLOWI BOT* 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀 𝙎𝙀 𝙈𝙊𝘿𝙄𝙁𝙄𝘾𝙊 𝙇𝘼 𝘿𝙀𝙎𝘾𝙍𝙄𝙋𝘾𝙄𝙊𝙉 𝘿𝙀 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊\n\n ✅𝘾𝙊𝙉 𝙀𝙓𝙄𝙏𝙊✅\n*𝙉𝙐𝙀𝙑𝘼 𝘿𝙀𝙎𝘾𝙍𝙄𝙋𝘾𝙄𝙊𝙉:* @desc'
conn.sSubject = '❗ *GLOWI BOT* 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀 𝙎𝙀 𝙈𝙊𝘿𝙄𝙁𝙄𝘾𝙊 𝙀𝙇 𝙉𝙊𝙈𝘽𝙍𝙀 𝘿𝙀 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊\n\n✅𝘾𝙊𝙉 𝙀𝙓𝙄𝙏𝙊✅\n*𝙉𝙐𝙀𝙑𝙊 𝙉𝙊𝙈𝘽𝙍𝙀:* @subject'
conn.sIcon = '❗ *GLOWI BOT* 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀 𝙎𝙀 𝙈𝙊𝘿𝙄𝙁𝙄𝘾𝙊 𝙇𝘼 𝙁𝙊𝙏𝙊 𝘿𝙀 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊\n\n\n*✅𝘾𝙊𝙉 𝙀𝙓𝙄𝙏𝙊✅*'
conn.sRevoke = '*❗GLOWI BOT 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀 𝙎𝙀 𝙃𝘼 𝘼𝘾𝙏𝙐𝘼𝙇𝙄𝙕𝘼𝘿𝙊 𝙀𝙇 𝙇𝙄𝙉𝙆 𝘿𝙀 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊\n\n✅𝘾𝙊𝙉 𝙀𝙓𝙄𝙏𝙊✅\n*𝙉𝙐𝙀𝙑𝙊 𝙇𝙄𝙉𝙆:* @revoke'
...
setInterval(async () => {
  ...
  const bio = `GLOWI BOT ⦙⦙ 💻 𝙊𝙉𝙇𝙄𝙉𝙀 𝙁𝘼𝙎𝙏 ${uptime}`;
