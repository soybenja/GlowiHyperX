...
conn.spromote = '❗ *𝙏𝘼𝙉𝙔 𝘽𝙊𝙏* 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀  @user 𝙀𝙎 𝙐𝙉 𝙉𝙐𝙀𝙑𝙊 𝘼𝘿𝙈𝙄𝙉 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊\n\n*𝙔𝘼 𝙏𝙄𝙀𝙉𝙀𝙎 𝙇𝙊𝙎 𝙋𝙊𝘿𝙀𝙍𝙀𝙎 𝘿𝙀 𝘼𝘿𝙈𝙄𝙉*'
conn.sdemote = '❗ *𝙏𝘼𝙉𝙔 𝘽𝙊𝙏* 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀 @user 𝙔𝘼 𝙉𝙊 𝙀𝙎 𝙐𝙉 𝘼𝘿𝙈𝙄𝙉 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊\n\n*𝙔𝘼 𝙉𝙊 𝙏𝙄𝙀𝙉𝙀𝙎 𝙇𝙊𝙎 𝙋𝙊𝘿𝙀𝙍𝙀𝙎 𝘿𝙀 𝘼𝘿𝙈𝙄𝙉*'
conn.sDesc = '❗ *𝙏𝘼𝙉𝙔 𝘽𝙊𝙏* 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀 𝙎𝙀 𝙈𝙊𝘿𝙄𝙁𝙄𝘾𝙊 𝙇𝘼 𝘿𝙀𝙎𝘾𝙍𝙄𝙋𝘾𝙄𝙊𝙉 𝘿𝙀 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊\n\n ✅𝘾𝙊𝙉 𝙀𝙓𝙄𝙏𝙊✅\n*𝙉𝙐𝙀𝙑𝘼 𝘿𝙀𝙎𝘾𝙍𝙄𝙋𝘾𝙄𝙊𝙉:* @desc'
conn.sSubject = '❗ *𝙏𝘼𝙉𝙔 𝘽𝙊𝙏* 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀 𝙎𝙀 𝙈𝙊𝘿𝙄𝙁𝙄𝘾𝙊 𝙀𝙇 𝙉𝙊𝙈𝘽𝙍𝙀 𝘿𝙀 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊\n\n✅𝘾𝙊𝙉 𝙀𝙓𝙄𝙏𝙊✅\n*𝙉𝙐𝙀𝙑𝙊 𝙉𝙊𝙈𝘽𝙍𝙀:* @subject'
conn.sIcon = '❗ *𝙏𝘼𝙉𝙔 𝘽𝙊𝙏* 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀 𝙎𝙀 𝙈𝙊𝘿𝙄𝙁𝙄𝘾𝙊 𝙇𝘼 𝙁𝙊𝙏𝙊 𝘿𝙀 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊\n\n\n*✅𝘾𝙊𝙉 𝙀𝙓𝙄𝙏𝙊✅*'
conn.sRevoke = '*❗𝙏𝘼𝙉𝙔 𝘽𝙊𝙏 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀 𝙎𝙀 𝙃𝘼 𝘼𝘾𝙏𝙐𝘼𝙇𝙄𝙕𝘼𝘿𝙊 𝙀𝙇 𝙇𝙄𝙉𝙆 𝘿𝙀 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊\n\n✅𝘾𝙊𝙉 𝙀𝙓𝙄𝙏𝙊✅\n*𝙉𝙐𝙀𝙑𝙊 𝙇𝙄𝙉𝙆:* @revoke'
